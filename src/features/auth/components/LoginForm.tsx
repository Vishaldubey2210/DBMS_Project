...
export function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (result?.error === "ACCOUNT_LOCKED") {
      setError("Account locked due to too many failed attempts. Try after 30 minutes.");
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-green-600 hover:bg-green-500 disabled:bg-green-800 disabled:cursor-not-allowed text-white font-semibold py-2.5 rounded-lg transition"
      >
